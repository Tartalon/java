public class XOR_encryption {
    ...
    //Используя XOR шифруем сообщение
    //В данном виде один ключь для шифрования и для рассшифровки
    // Криптостойкость данного ключа можно увеличить если увеличить его длину
    ...
    public static void main(String[] args) {
        ...
        // Разшифровываем. character = 0100 0100 (68)
